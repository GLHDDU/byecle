...
#define AT_RX_BUF 		USART3_RX_BUF//AT串口缓存，它是一个数组
#define F_AT_RX_FINISH	F_USART3_RX_FINISH//AT串口数据接收完毕标志，取值0或1
#define AT_RX_COUNT		USART3_RX_COUNT////AT串口接收到的数据个数
