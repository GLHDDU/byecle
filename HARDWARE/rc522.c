...
#define RS522_RST(N) GPIO_WriteBit(RC522_RST_GPIO_PORT, RC522_RST_PIN, N==1?Bit_SET:Bit_RESET)
#define RS522_NSS(N) GPIO_WriteBit(RC522_CS_GPIO_PORT, RC522_CS_PIN, N==1?Bit_SET:Bit_RESET)
